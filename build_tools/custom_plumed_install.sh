...
# OpenMM
git clone --branch 8.4.0 --depth 1 --filter=blob:none https://github.com/openmm/openmm.git && cd openmm
...
# OpenMM-ML
git clone --branch 1.5 --depth 1 --filter=blob:none https://github.com/openmm/openmm-ml.git && cd openmm-ml
pip install .
cd ..
